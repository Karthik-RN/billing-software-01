    ...
    <div className="homepage-container bg-gray-800 min-h-screen">
      <div>
        ...
        <div className='homepage-container p-10'>
          <Link to='/bills/create-new-bill' className=' mr-4 rounded-lg border border-transparent px-3 py-2 text-base font-semibold bg-black text-white cursor-pointer transition duration-250 hover:border-indigo-600 hover:text-indigo-600 '>Create New Bill</Link>
